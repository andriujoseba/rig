...
- `rig runner install --name` refuses a directory already holding a runner install rig did not create, instead of writing its marker into it and adopting it (#166).
